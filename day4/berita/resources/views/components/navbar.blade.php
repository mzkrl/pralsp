...
<nav class="flex bg-blue-950 shadow-xl py-6 px-8 justify-between">
    ...
    <li class="flex gap-2">
        ...
        @if (session('login') )
            <ul>
                <a href="/user/logout">
                    <button class="btn btn-ghost flex my-auto text-gray-100 text-md font-bold py-2 px-6">Log out</button>
                </a>
            </ul>
        @else
            <ul>
                <a href="/user/login">
                    <button class="btn btn-ghost flex my-auto text-gray-100 text-md font-bold py-2 px-6">Login</button>
                </a>
            </ul>
            <ul>
                <a href="/user/signup">
                    <button class="btn btn-ghost flex my-auto text-gray-100 text-md font-bold py-2 px-6">Sign Up</button>
                </a>
            </ul>
        @endif
    </li>
